...
const ProjectApproval = () => {
    ...
    return (
        <>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                    <div className="min-h-[40px] flex items-center">
                        {selectedIds.size > 0 ? (
                            ...
                            <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tight">Project Approvals</h2>
                        )}
                    </div>
            ...
            <AddDocument isOpen={isAddModalOpen} onClose={() => { setIsAddModalOpen(false); fetchData(); }} initialCategory="Project" />
