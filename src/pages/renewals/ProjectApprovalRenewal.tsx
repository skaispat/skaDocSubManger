...
import { Search, CheckCircle, X, Check, Calendar, Download, RotateCcw, Upload } from 'lucide-react';
...
const ProjectApprovalRenewal = () => {
    ...
    const baseDocs = documents.filter(doc => doc.category === 'Project Approval' && doc.needsRenewal && doc.renewalDate);
    ...
    const handleDownload = (fileContent: string | undefined, fileName: string | null) => {
        if (!fileContent && (!fileName || !fileName.startsWith('http'))) {
            setAlertMessage("Approval document file is not available in the database.");
            setShowAlert(true);
            return;
        }
        if (fileName?.startsWith('http')) {
            ...
            link.download = fileName || 'project_approval';
        ...
        <div className="space-y-4 font-sans">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <div className="relative flex-1 w-full max-w-lg">
                    ...
                    <input
                        type="text"
                        placeholder="SEARCH PROJECT APPROVALS..."
                            ...
                            {displayDocs.length > 0 ? displayDocs.map((doc) => {
                                ...
                                return (
                                    <tr key={doc.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="px-5 py-3 text-gray-600 font-medium text-sm">{doc.companyName}</td>
                                        <td className="px-5 py-3 text-center">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-scale-in">
                        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                            <h3 className="text-lg font-bold text-gray-900">Project Renewal</h3>
                        ...
                        <form onSubmit={handleSaveRenewal} className="p-6 space-y-4">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                    <span className="text-sm font-medium text-gray-700">Extend project?</span>
                                    <button 
                                        type="button"
                                ...
                                {againRenewal && (
                                    <div className="space-y-4 animate-fade-in">
                                        <div>
                                            <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">New Validity Date</label>
                                            <input 
                                                type="date" 
                                                required
                                        ...
                                        <div>
                                            <label className="block text-[10px] font-black text-gray-900 uppercase tracking-widest mb-1">Upload Revised Approval</label>
